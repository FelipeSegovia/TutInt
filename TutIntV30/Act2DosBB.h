...
namespace TutIntV30 {
	...
	/// <summary>
	/// Resumen de Act2DosBB
	/// </summary>
	public ref class Act2DosBB : public System::Windows::Forms::Form
	{
	public:
		Act2DosBB(void)
		{
		...
		Act2DosBB(Form^ f, BaseDeDatos^ manejador, AgenteControlador* control)
		{
			form = f;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Act2DosBB::typeid));
			...
			this->panelPrincipal->Size = System::Drawing::Size(1496, 668);
			...
			this->btnListo->Click += gcnew System::EventHandler(this, &Act2DosBB::btnListo_Click);
			this->btnListo->MouseLeave += gcnew System::EventHandler(this, &Act2DosBB::btnListo_MouseLeave);
			this->btnListo->MouseHover += gcnew System::EventHandler(this, &Act2DosBB::btnListo_MouseHover);
			// 
			// btnVolver
			// 
			...
			this->btnVolver->Click += gcnew System::EventHandler(this, &Act2DosBB::btnVolver_Click);
			this->btnVolver->MouseLeave += gcnew System::EventHandler(this, &Act2DosBB::btnVolver_MouseLeave);
			this->btnVolver->MouseHover += gcnew System::EventHandler(this, &Act2DosBB::btnVolver_MouseHover);
			// 
			// panel2
			// 
			...
			this->btnCuatro->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnCuatro_MouseDown);
			this->btnCuatro->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnCuatro_MouseMove);
			this->btnCuatro->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnCuatro_MouseUp);
			// 
			// btnTres
			// 
			...
			this->btnTres->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnTres_MouseDown);
			this->btnTres->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnTres_MouseMove);
			this->btnTres->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnTres_MouseUp);
			// 
			// btnDos
			// 
			...
			this->btnDos->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnDos_MouseDown);
			this->btnDos->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnDos_MouseMove);
			this->btnDos->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnDos_MouseUp);
			// 
			// btnUno
			// 
			...
			this->btnUno->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnUno_MouseDown);
			this->btnUno->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnUno_MouseMove);
			this->btnUno->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2DosBB::btnUno_MouseUp);
			// 
			// panelTres3
			// 
			this->panelTres3->BackColor = System::Drawing::Color::BlueViolet;
			...
			// panelDos3
			// 
			this->panelDos3->BackColor = System::Drawing::Color::BlueViolet;
			...
			// panelUno3
			// 
			this->panelUno3->BackColor = System::Drawing::Color::BlueViolet;
			...
			this->panel1->Location = System::Drawing::Point(180, 4);
			...
			this->btnAyuda->Click += gcnew System::EventHandler(this, &Act2DosBB::btnAyuda_Click);
			this->btnAyuda->MouseLeave += gcnew System::EventHandler(this, &Act2DosBB::btnAyuda_MouseLeave);
			this->btnAyuda->MouseHover += gcnew System::EventHandler(this, &Act2DosBB::btnAyuda_MouseHover);
			// 
			// panel9
			// 
			...
			this->panel9->Size = System::Drawing::Size(1496, 39);
			...
			this->picMinimizar->Location = System::Drawing::Point(1410, 3);
			...
			this->picMinimizar->Click += gcnew System::EventHandler(this, &Act2DosBB::picMinimizar_Click);
			// 
			// picCerrar
			// 
			...
			this->picCerrar->Location = System::Drawing::Point(1453, 3);
			...
			this->picCerrar->Click += gcnew System::EventHandler(this, &Act2DosBB::picCerrar_Click);
			// 
			// timer1
			// 
			this->timer1->Interval = 1;
			this->timer1->Tick += gcnew System::EventHandler(this, &Act2DosBB::timer1_Tick);
			// 
			// Act2DosBB
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(8, 16);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(1496, 707);
			this->Controls->Add(this->panelPrincipal);
			this->Controls->Add(this->panel9);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Icon = (cli::safe_cast<System::Drawing::Icon^>(resources->GetObject(L"$this.Icon")));
			this->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->Name = L"Act2DosBB";
			this->Opacity = 0;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Act2DosBB";
			this->Activated += gcnew System::EventHandler(this, &Act2DosBB::Act2DosBB_Activated);
			this->Deactivate += gcnew System::EventHandler(this, &Act2DosBB::Act2DosBB_Deactivate);
			this->Load += gcnew System::EventHandler(this, &Act2DosBB::Act2DosBB_Load);
...
#pragma endregion
	...
	private: System::Void Act2DosBB_Load(System::Object^  sender, System::EventArgs^  e);
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2DosBB_Activated(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2DosBB_Deactivate(System::Object^  sender, System::EventArgs^  e);
