...
System::Void TutIntV30::Act2DosII::inicializarTam() {
...
System::Void TutIntV30::Act2DosII::comprobarRespuestas() {
...
System::Void TutIntV30::Act2DosII::btnVolver_Click(System::Object^  sender, System::EventArgs^  e) {
	//hiloAct->Abort();
	Advertencia^ ventana = gcnew Advertencia("etapaDos", this, false, manejadorBD);
	ventana->ShowDialog();
}
vector<TiempoMI*> TutIntV30::Act2DosII::obtenerTiempoItems() {
...
System::Void TutIntV30::Act2DosII::btnListo_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
...
System::Void TutIntV30::Act2DosII::btnVolver_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver + 5, hVolver + 5);
}
System::Void TutIntV30::Act2DosII::btnVolver_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver, hVolver);
}
System::Void TutIntV30::Act2DosII::btnListo_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo + 5, hListo + 5);
}
System::Void TutIntV30::Act2DosII::btnListo_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo, hListo);
}
System::Void TutIntV30::Act2DosII::btnAyuda_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda + 5, hAyuda + 5);
}
System::Void TutIntV30::Act2DosII::btnAyuda_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda, hAyuda);
}
System::Void TutIntV30::Act2DosII::sonidoInicial() {
	//PlaySound(TEXT("Audios/Oceano/actividad_1.wav"), NULL, SND_ASYNC);
}
System::Void TutIntV30::Act2DosII::btnAyuda_Click(System::Object^  sender, System::EventArgs^  e) {
	//sonidoInicial();
	this->contAyuda++;
	if (this->instruccion1->Visible == true) {
		this->instruccion1->Visible = false;
		this->instruccion2->Visible = true;
		//PlaySound(TEXT("Audios/Oceano/Habilidad2/Nivel Intermedio/Complejidad intermedia/NI_CI_lvoz2.wav"), NULL, SND_ASYNC);
	}
	else if (this->instruccion2->Visible == true) {
		this->instruccion2->Visible = false;
		this->instruccion1->Visible = true;
		//PlaySound(TEXT("Audios/Oceano/Habilidad2/Nivel Intermedio/Complejidad intermedia/NI_CI_lvoz1.wav"), NULL, SND_ASYNC);
	}
}
System::Void TutIntV30::Act2DosII::picCerrar_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
	Application::Exit();
}
System::Void TutIntV30::Act2DosII::picMinimizar_Click(System::Object^  sender, System::EventArgs^  e) {
	this->WindowState = FormWindowState::Minimized;
}
System::Void TutIntV30::Act2DosII::timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
	this->Opacity += .1;
	//Detener el timer
	if (this->Opacity == 1) {
		this->timer1->Stop();
...
System::Void TutIntV30::Act2DosII::Act2DosII_Load(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
	//PlaySound(TEXT("Audios/Oceano/Habilidad2/Nivel Intermedio/Complejidad intermedia/NI_CI_lvoz1.wav"), NULL, SND_ASYNC);
...
System::Void TutIntV30::Act2DosII::Act2DosII_Activated(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
}
System::Void TutIntV30::Act2DosII::Act2DosII_Deactivate(System::Object^  sender, System::EventArgs^  e) {
	if (this->WindowState == FormWindowState::Minimized) {
		this->Opacity = 0;
	}
}
System::Void TutIntV30::Act2DosII::tiempo_respuesta(int numItem, TiempoGUI^ tr_item, bool listoBtn)
{
	if (listoBtn == true) {
...
System::Void TutIntV30::Act2DosII::btn1Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn1 = true;
...
System::Void TutIntV30::Act2DosII::btn1No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn1 = true;
	tiempo_respuesta(1, t_item1, listoBtn1);
...
System::Void TutIntV30::Act2DosII::btn2Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn2 = true;
...
System::Void TutIntV30::Act2DosII::btn2No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn2 = true;
	tiempo_respuesta(2, t_item2, listoBtn2);
...
System::Void TutIntV30::Act2DosII::btn3Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn3 = true;
...
System::Void TutIntV30::Act2DosII::btn3No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn3 = true;
	tiempo_respuesta(3, t_item3, listoBtn3);
...
System::Void TutIntV30::Act2DosII::btn4Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn4 = true;
...
System::Void TutIntV30::Act2DosII::btn4No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn4 = true;
	tiempo_respuesta(4, t_item4, listoBtn4);
