...
namespace TutIntV30 {
	...
	/// <summary>
	/// Resumen de Act2DosDD
	/// </summary>
	public ref class Act2DosDD : public System::Windows::Forms::Form
	{
	public:
		Act2DosDD(void)
		{
		...
		Act2DosDD(Form^ f, BaseDeDatos^ manejador, AgenteControlador* control)
		{
			form = f;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Act2DosDD::typeid));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Act2DosDD::timer1_Tick);
			// 
			// panelPrincipal
			// 
			...
			this->panelPrincipal->Size = System::Drawing::Size(1367, 676);
			...
			this->panel1->Location = System::Drawing::Point(179, 4);
			this->panel1->Margin = System::Windows::Forms::Padding(2);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(995, 54);
			...
			this->instruccion1->Location = System::Drawing::Point(65, 7);
			this->instruccion1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->instruccion1->Name = L"instruccion1";
			this->instruccion1->Size = System::Drawing::Size(749, 38);
			this->instruccion1->TabIndex = 14;
			this->instruccion1->Text = L"Ordenemos las imágenes, segun el orden del abecedario";
			// 
			// instruccion2
			// 
			...
			this->instruccion2->Location = System::Drawing::Point(62, 5);
			this->instruccion2->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->instruccion2->Name = L"instruccion2";
			this->instruccion2->Size = System::Drawing::Size(827, 38);
			this->instruccion2->TabIndex = 13;
			this->instruccion2->Text = L"Para ordenar las imágenes, guíate por la letra con que inician";
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 48, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(876, 453);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 48, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(876, 337);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 48, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(876, 207);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 48, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(876, 89);
			...
			this->btnTres->Location = System::Drawing::Point(156, 292);
			this->btnTres->Margin = System::Windows::Forms::Padding(2);
			this->btnTres->Name = L"btnTres";
			this->btnTres->Size = System::Drawing::Size(182, 120);
			...
			this->btnDos->Location = System::Drawing::Point(429, 152);
			this->btnDos->Margin = System::Windows::Forms::Padding(2);
			this->btnDos->Name = L"btnDos";
			this->btnDos->Size = System::Drawing::Size(182, 120);
			...
			this->btnUno->Location = System::Drawing::Point(156, 89);
			this->btnUno->Margin = System::Windows::Forms::Padding(2);
			this->btnUno->Name = L"btnUno";
			this->btnUno->Size = System::Drawing::Size(182, 120);
			...
			this->btnCuatro->Location = System::Drawing::Point(429, 376);
			this->btnCuatro->Margin = System::Windows::Forms::Padding(2);
			this->btnCuatro->Name = L"btnCuatro";
			this->btnCuatro->Size = System::Drawing::Size(182, 120);
			...
			this->panelCuatro->Location = System::Drawing::Point(687, 439);
			this->panelCuatro->Margin = System::Windows::Forms::Padding(2);
			this->panelCuatro->Name = L"panelCuatro";
			this->panelCuatro->Size = System::Drawing::Size(184, 122);
			...
			this->panelTres->Location = System::Drawing::Point(687, 316);
			this->panelTres->Margin = System::Windows::Forms::Padding(2);
			this->panelTres->Name = L"panelTres";
			this->panelTres->Size = System::Drawing::Size(184, 122);
			...
			this->panelDos->Location = System::Drawing::Point(687, 192);
			this->panelDos->Margin = System::Windows::Forms::Padding(2);
			this->panelDos->Name = L"panelDos";
			this->panelDos->Size = System::Drawing::Size(184, 122);
			...
			this->panelUno->Location = System::Drawing::Point(687, 69);
			this->panelUno->Margin = System::Windows::Forms::Padding(2);
			this->panelUno->Name = L"panelUno";
			this->panelUno->Size = System::Drawing::Size(184, 122);
			...
			this->btnAyuda->Location = System::Drawing::Point(4, 7);
			...
			this->panel9->Size = System::Drawing::Size(1367, 39);
			...
			this->picMinimizar->Location = System::Drawing::Point(1281, 3);
			...
			this->picCerrar->Location = System::Drawing::Point(1324, 3);
			...
			this->ClientSize = System::Drawing::Size(1367, 715);
			this->Controls->Add(this->panelPrincipal);
			this->Controls->Add(this->panel9);
			this->FormBorderStyle = System::Windows::Forms::FormBorderStyle::None;
			this->Icon = (cli::safe_cast<System::Drawing::Icon^>(resources->GetObject(L"$this.Icon")));
			this->Margin = System::Windows::Forms::Padding(2);
			this->Name = L"Act2DosDD";
			this->Opacity = 0;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Act2DosDD";
			this->Activated += gcnew System::EventHandler(this, &Act2DosDD::Act2DosDD_Activated);
			this->Deactivate += gcnew System::EventHandler(this, &Act2DosDD::Act2DosDD_Deactivate);
			this->Load += gcnew System::EventHandler(this, &Act2DosDD::Act2DosDD_Load);
...
#pragma endregion
	...
	private: System::Void Act2DosDD_Load(System::Object^  sender, System::EventArgs^  e);
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2DosDD_Activated(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2DosDD_Deactivate(System::Object^  sender, System::EventArgs^  e);
