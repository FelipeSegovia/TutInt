...
namespace TutIntV30 {
	...
	/// <summary>
	/// Resumen de Act2UnoID
	/// </summary>
	public ref class Act2UnoID : public System::Windows::Forms::Form
	{
	public:
		Act2UnoID(void)
		{
		...
		Act2UnoID(Form^ f, BaseDeDatos^ manejador, AgenteControlador* control)
		{
			form = f;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Act2UnoID::typeid));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Act2UnoID::timer1_Tick);
			// 
			// panelPrincipal
			// 
			...
			this->label2->Size = System::Drawing::Size(715, 70);
			this->label2->TabIndex = 13;
			this->label2->Text = L"Selecciona manito arriba si el objeto contiene la letra \"D\", \r\nde lo contrario se"
			...
			this->lblinstr1->Size = System::Drawing::Size(617, 38);
			this->lblinstr1->TabIndex = 14;
			this->lblinstr1->Text = L"Veamos si las imágenes contienen la letra \"D\"";
			// 
			// panel13
			// 
			...
			this->panel2->Location = System::Drawing::Point(289, 92);
			this->panel2->Margin = System::Windows::Forms::Padding(2);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(1095, 604);
			...
			this->btn4->Location = System::Drawing::Point(602, 318);
			this->btn4->Margin = System::Windows::Forms::Padding(2);
			this->btn4->Name = L"btn4";
			this->btn4->Size = System::Drawing::Size(162, 110);
			...
			this->btn2->Location = System::Drawing::Point(645, 127);
			this->btn2->Margin = System::Windows::Forms::Padding(2);
			this->btn2->Name = L"btn2";
			this->btn2->Size = System::Drawing::Size(120, 147);
			...
			this->Name = L"Act2UnoID";
			this->Opacity = 0;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Act2UnoID";
			this->Activated += gcnew System::EventHandler(this, &Act2UnoID::Act2UnoID_Activated);
			this->Deactivate += gcnew System::EventHandler(this, &Act2UnoID::Act2UnoID_Deactivate);
			this->Load += gcnew System::EventHandler(this, &Act2UnoID::Act2UnoID_Load);
...
#pragma endregion
	...
	private: System::Void Act2UnoID_Load(System::Object^  sender, System::EventArgs^  e);
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2UnoID_Activated(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2UnoID_Deactivate(System::Object^  sender, System::EventArgs^  e);
