...
namespace TutIntV30 {
	...
	/// <summary>
	/// Resumen de Act2UnoBI
	/// </summary>
	public ref class Act2UnoBI : public System::Windows::Forms::Form
	{
	public:
		Act2UnoBI(void)
		{
		...
		Act2UnoBI(Form^ f, BaseDeDatos^ manejador, AgenteControlador* control)
		{
			form = f;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Act2UnoBI::typeid));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &Act2UnoBI::timer1_Tick);
			// 
			// panelPrincipal
			// 
			...
			this->panel1->Location = System::Drawing::Point(183, 4);
			...
			this->instruccion1->Location = System::Drawing::Point(62, 7);
			...
			this->instruccion2->Location = System::Drawing::Point(61, 5);
			...
			this->panelTres3->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelDos3->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelTres2->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelUno3->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelTres1->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelDos2->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelDos1->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelUno2->Margin = System::Windows::Forms::Padding(2);
			...
			this->panelUno1->Margin = System::Windows::Forms::Padding(2);
			...
			this->Name = L"Act2UnoBI";
			this->Opacity = 0;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Act2UnoBI";
			this->Activated += gcnew System::EventHandler(this, &Act2UnoBI::Act2UnoBI_Activated);
			this->Deactivate += gcnew System::EventHandler(this, &Act2UnoBI::Act2UnoBI_Deactivate);
			this->Load += gcnew System::EventHandler(this, &Act2UnoBI::Act2UnoBI_Load);
...
#pragma endregion
	...
	private: System::Void Act2UnoBI_Load(System::Object^  sender, System::EventArgs^  e);
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2UnoBI_Activated(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2UnoBI_Deactivate(System::Object^  sender, System::EventArgs^  e);
