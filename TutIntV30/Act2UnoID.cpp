...
System::Void TutIntV30::Act2UnoID::inicializarTam() {
...
System::Void TutIntV30::Act2UnoID::comprobarRespuestas() {
...
System::Void TutIntV30::Act2UnoID::btnVolver_Click(System::Object^  sender, System::EventArgs^  e) {
	//hiloAct->Abort();
	Advertencia^ ventana = gcnew Advertencia("etapaDos", this, false, manejadorBD);
	ventana->ShowDialog();
}
vector<TiempoMI*> TutIntV30::Act2UnoID::obtenerTiempoItems() {
...
System::Void TutIntV30::Act2UnoID::btnListo_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
...
System::Void TutIntV30::Act2UnoID::btnVolver_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver + 5, hVolver + 5);
}
System::Void TutIntV30::Act2UnoID::btnVolver_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver, hVolver);
}
System::Void TutIntV30::Act2UnoID::btnListo_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo + 5, hListo + 5);
}
System::Void TutIntV30::Act2UnoID::btnListo_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo, hListo);
}
System::Void TutIntV30::Act2UnoID::btnAyuda_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda + 5, hAyuda + 5);
}
System::Void TutIntV30::Act2UnoID::btnAyuda_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda, hAyuda);
}
System::Void TutIntV30::Act2UnoID::sonidoInicial() {
	//PlaySound(TEXT("Audios/Oceano/actividad_1.wav"), NULL, SND_ASYNC);
}
System::Void TutIntV30::Act2UnoID::btnAyuda_Click(System::Object^  sender, System::EventArgs^  e) {
	//sonidoInicial();
	this->contAyuda++;
	if (this->instruccion1->Visible == true) {
		this->instruccion1->Visible = false;
		this->instruccion2->Visible = true;
		//PlaySound(TEXT("Audios/Oceano/Habilidad2/Nivel Intermedio/Complejidad dificil/NI_CD_dvoz2.wav"), NULL, SND_ASYNC);
	}
	else if (this->instruccion2->Visible == true) {
		this->instruccion2->Visible = false;
		this->instruccion1->Visible = true;
		//PlaySound(TEXT("Audios/Oceano/Habilidad2/Nivel Intermedio/Complejidad dificil/NI_CD_dvoz1.wav"), NULL, SND_ASYNC);
	}
}
System::Void TutIntV30::Act2UnoID::picCerrar_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
	Application::Exit();
}
System::Void TutIntV30::Act2UnoID::picMinimizar_Click(System::Object^  sender, System::EventArgs^  e) {
	this->WindowState = FormWindowState::Minimized;
}
System::Void TutIntV30::Act2UnoID::timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
	this->Opacity += .1;
	//Detener el timer
	if (this->Opacity == 1) {
		this->timer1->Stop();
...
System::Void TutIntV30::Act2UnoID::Act2UnoID_Load(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
	//PlaySound(TEXT("Audios/Oceano/Habilidad2/Nivel Intermedio/Complejidad dificil/NI_CD_dvoz1.wav"), NULL, SND_ASYNC);
...
System::Void TutIntV30::Act2UnoID::Act2UnoID_Activated(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
}
System::Void TutIntV30::Act2UnoID::Act2UnoID_Deactivate(System::Object^  sender, System::EventArgs^  e) {
	if (this->WindowState == FormWindowState::Minimized) {
		this->Opacity = 0;
	}
}
System::Void TutIntV30::Act2UnoID::tiempo_respuesta(int numItem, TiempoGUI^ tr_item, bool listoBtn)
{
	if (listoBtn == true) {
...
System::Void TutIntV30::Act2UnoID::btn1Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn1 = true;
...
System::Void TutIntV30::Act2UnoID::btn1No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn1 = true;
	tiempo_respuesta(1, t_item1, listoBtn1);
...
System::Void TutIntV30::Act2UnoID::btn2Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn2 = true;
...
System::Void TutIntV30::Act2UnoID::btn2No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn2 = true;
	tiempo_respuesta(2, t_item2, listoBtn2);
...
System::Void TutIntV30::Act2UnoID::btn3Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn3 = true;
...
System::Void TutIntV30::Act2UnoID::btn3No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn3 = true;
	tiempo_respuesta(3, t_item3, listoBtn3);
...
System::Void TutIntV30::Act2UnoID::btn4Si_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn4 = true;
...
System::Void TutIntV30::Act2UnoID::btn4No_Click(System::Object^  sender, System::EventArgs^  e) {
	listoBtn4 = true;
	tiempo_respuesta(4, t_item4, listoBtn4);
