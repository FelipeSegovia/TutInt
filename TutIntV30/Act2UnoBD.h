...
namespace TutIntV30 {
	...
	/// <summary>
	/// Resumen de Act2UnoBD
	/// </summary>
	public ref class Act2UnoBD : public System::Windows::Forms::Form
	{
	public:
		Act2UnoBD(void)
		{
		...
		Act2UnoBD(Form^ f, BaseDeDatos^ manejador, AgenteControlador* control)
		{
			form = f;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(Act2UnoBD::typeid));
			...
			this->btnListo->Click += gcnew System::EventHandler(this, &Act2UnoBD::btnListo_Click);
			this->btnListo->MouseLeave += gcnew System::EventHandler(this, &Act2UnoBD::btnListo_MouseLeave);
			this->btnListo->MouseHover += gcnew System::EventHandler(this, &Act2UnoBD::btnListo_MouseHover);
			// 
			// btnVolver
			// 
			...
			this->btnVolver->Click += gcnew System::EventHandler(this, &Act2UnoBD::btnVolver_Click);
			this->btnVolver->MouseLeave += gcnew System::EventHandler(this, &Act2UnoBD::btnVolver_MouseLeave);
			this->btnVolver->MouseHover += gcnew System::EventHandler(this, &Act2UnoBD::btnVolver_MouseHover);
			// 
			// panel2
			// 
			...
			this->btnCuatro->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnCuatro_MouseDown);
			this->btnCuatro->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnCuatro_MouseMove);
			this->btnCuatro->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnCuatro_MouseUp);
			// 
			// btnTres
			// 
			...
			this->btnTres->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnTres_MouseDown);
			this->btnTres->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnTres_MouseMove);
			this->btnTres->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnTres_MouseUp);
			// 
			// btnDos
			// 
			...
			this->btnDos->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnDos_MouseDown);
			this->btnDos->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnDos_MouseMove);
			this->btnDos->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnDos_MouseUp);
			// 
			// btnUno
			// 
			...
			this->btnUno->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnUno_MouseDown);
			this->btnUno->MouseMove += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnUno_MouseMove);
			this->btnUno->MouseUp += gcnew System::Windows::Forms::MouseEventHandler(this, &Act2UnoBD::btnUno_MouseUp);
			// 
			// panelTres3
			// 
			...
			this->btnAyuda->Click += gcnew System::EventHandler(this, &Act2UnoBD::btnAyuda_Click);
			this->btnAyuda->MouseLeave += gcnew System::EventHandler(this, &Act2UnoBD::btnAyuda_MouseLeave);
			this->btnAyuda->MouseHover += gcnew System::EventHandler(this, &Act2UnoBD::btnAyuda_MouseHover);
			// 
			// panel9
			// 
			...
			this->picMinimizar->Click += gcnew System::EventHandler(this, &Act2UnoBD::picMinimizar_Click);
			// 
			// picCerrar
			// 
			...
			this->picCerrar->Click += gcnew System::EventHandler(this, &Act2UnoBD::picCerrar_Click);
			// 
			// timer1
			// 
			this->timer1->Interval = 1;
			this->timer1->Tick += gcnew System::EventHandler(this, &Act2UnoBD::timer1_Tick);
			// 
			// panel1
			// 
			...
			this->panel1->Location = System::Drawing::Point(316, 7);
			...
			this->Name = L"Act2UnoBD";
			this->Opacity = 0;
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Act2UnoBD";
			this->Activated += gcnew System::EventHandler(this, &Act2UnoBD::Act2UnoBD_Activated);
			this->Deactivate += gcnew System::EventHandler(this, &Act2UnoBD::Act2UnoBD_Deactivate);
			this->Load += gcnew System::EventHandler(this, &Act2UnoBD::Act2UnoBD_Load);
...
#pragma endregion
	...
	private: System::Void Act2UnoBD_Load(System::Object^  sender, System::EventArgs^  e);
	private: System::Void timer1_Tick(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2UnoBD_Activated(System::Object^  sender, System::EventArgs^  e);
	private: System::Void Act2UnoBD_Deactivate(System::Object^  sender, System::EventArgs^  e);
