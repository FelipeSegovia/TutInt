...
System::Void TutIntV30::Act1DosBD::inicializarTam() {
...
System::Void TutIntV30::Act1DosBD::comprobarRespuestas() {
	if (listoGaviota == true && listoPelicano == true && listoTortuga == true && listoCangrejo == true) {
		this->btnListo->Visible = true;
		this->btnListo->Enabled = true;
	}
}
System::Void TutIntV30::Act1DosBD::btnVolver_Click(System::Object^  sender, System::EventArgs^  e) {
	//hiloAct->Abort();
	Advertencia^ ventana = gcnew Advertencia("etapaUno", this, false, manejadorBD);
	ventana->ShowDialog();
}
vector<TiempoMI*> TutIntV30::Act1DosBD::obtenerTiempoItems() {
...
System::Void TutIntV30::Act1DosBD::btnListo_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
	...
	string stringBtn1 = context.marshal_as<std::string>(this->textTortuga->Text->ToString());
	respuestas.push_back(stringBtn1);
	stringBtn1.clear();

	string stringBtn2 = context.marshal_as<std::string>(this->textGaviota->Text->ToString());
	respuestas.push_back(stringBtn2);
	stringBtn2.clear();

	string stringBtn3 = context.marshal_as<std::string>(this->textPelicano->Text->ToString());
	respuestas.push_back(stringBtn3);
	stringBtn3.clear();

	string stringBtn4 = context.marshal_as<std::string>(this->textCangrejo->Text->ToString());
	respuestas.push_back(stringBtn4);
	stringBtn4.clear();

	controlador->setPercepcionesActividad(respuestas, contAyuda, tiempoItems, tiempoAct);
	controlador->setPercepcionesNivelActividad("Conciencia_fonologica", "Basica", "Dificil", 2);
...
System::Void TutIntV30::Act1DosBD::btnVolver_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver + 5, hVolver + 5);
}
System::Void TutIntV30::Act1DosBD::btnVolver_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnVolver->Size = System::Drawing::Size(wVolver, hVolver);
}
System::Void TutIntV30::Act1DosBD::btnListo_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo + 5, hListo + 5);
}
System::Void TutIntV30::Act1DosBD::btnListo_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnListo->Size = System::Drawing::Size(wListo, hListo);
}
System::Void TutIntV30::Act1DosBD::btnAyuda_MouseHover(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda + 5, hAyuda + 5);
}
System::Void TutIntV30::Act1DosBD::btnAyuda_MouseLeave(System::Object^  sender, System::EventArgs^  e) {
	this->btnAyuda->Size = System::Drawing::Size(wAyuda, hAyuda);
}
System::Void TutIntV30::Act1DosBD::sonidoInicial() {
	//PlaySound(TEXT("Audios/Oceano/actividad_1.wav"), NULL, SND_ASYNC);
}
System::Void TutIntV30::Act1DosBD::btnAyuda_Click(System::Object^  sender, System::EventArgs^  e) {
	//sonidoInicial();
	this->contAyuda++;
...
System::Void TutIntV30::Act1DosBD::picCerrar_Click(System::Object^  sender, System::EventArgs^  e) {
	hiloAct->Abort();
	Application::Exit();
}
System::Void TutIntV30::Act1DosBD::picMinimizar_Click(System::Object^  sender, System::EventArgs^  e) {
	this->WindowState = FormWindowState::Minimized;
}
System::Void TutIntV30::Act1DosBD::timer1_Tick(System::Object^  sender, System::EventArgs^  e) {
	this->Opacity += .1;
	//Detener el timer
	if (this->Opacity == 1) {
		this->timer1->Stop();
...
System::Void TutIntV30::Act1DosBD::Act1DosBD_Load(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
	//PlaySound(TEXT("Audios/Oceano/Habilidad1/Nivel Dificil/Complejidad dificil/ND_CD_voz1.wav"), NULL, SND_ASYNC);
...
System::Void TutIntV30::Act1DosBD::Act1DosBD_Activated(System::Object^  sender, System::EventArgs^  e) {
	this->timer1->Start();
}
System::Void TutIntV30::Act1DosBD::Act1DosBD_Deactivate(System::Object^  sender, System::EventArgs^  e) {
	if (this->WindowState == FormWindowState::Minimized) {
		this->Opacity = 0;
	}
}
System::Void TutIntV30::Act1DosBD::tiempo_respuesta(int numItem, TiempoGUI^ tr_item, System::Windows::Forms::TextBox^ textBox)
{
	if (textBox->Text != "") {
...
void TutIntV30::Act1DosBD::cambiarColor() {
	this->textTortuga->BackColor = System::Drawing::Color::White;
	this->textTortuga->ForeColor = System::Drawing::Color::Black;
	this->lblTortuga->ForeColor = System::Drawing::Color::Black;
	this->textCangrejo->BackColor = System::Drawing::Color::White;
	this->textCangrejo->ForeColor = System::Drawing::Color::Black;
	this->lblCangrejo->ForeColor = System::Drawing::Color::Black;
	this->textGaviota->BackColor = System::Drawing::Color::White;
	this->textGaviota->ForeColor = System::Drawing::Color::Black;
	this->lblGaviota->ForeColor = System::Drawing::Color::Black;
	this->textPelicano->BackColor = System::Drawing::Color::White;
	this->textPelicano->ForeColor = System::Drawing::Color::Black;
	this->lblPelicano->ForeColor = System::Drawing::Color::Black;
}
System::Void TutIntV30::Act1DosBD::textTortuga_KeyPress(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) {
...
System::Void TutIntV30::Act1DosBD::textPelicano_KeyPress(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) {
	if (!(Char::IsNumber(e->KeyChar)) && (e->KeyChar != (char)Keys::Back))
	{
		textPelicano->Text = "";
		e->Handled = true;
...
System::Void TutIntV30::Act1DosBD::textGaviota_KeyPress(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) {
	if (!(Char::IsNumber(e->KeyChar)) && (e->KeyChar != (char)Keys::Back))
	{
		textGaviota->Text = "";
		e->Handled = true;
...
System::Void TutIntV30::Act1DosBD::textCangrejo_KeyPress(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) {
	if (!(Char::IsNumber(e->KeyChar)) && (e->KeyChar != (char)Keys::Back))
	{
		textCangrejo->Text = "";
		e->Handled = true;
...
System::Void TutIntV30::Act1DosBD::textTortuga_Click(System::Object^  sender, System::EventArgs^  e) {
	cambiarColor();
...
System::Void TutIntV30::Act1DosBD::textPelicano_Click(System::Object^  sender, System::EventArgs^  e) {
	cambiarColor();
	this->textPelicano->BackColor = System::Drawing::Color::DarkViolet;
	this->textPelicano->ForeColor = System::Drawing::Color::White;
	this->lblPelicano->ForeColor = System::Drawing::Color::DarkViolet;
}
System::Void TutIntV30::Act1DosBD::textGaviota_Click(System::Object^  sender, System::EventArgs^  e) {
	cambiarColor();
	this->textGaviota->BackColor = System::Drawing::Color::DarkViolet;
	this->textGaviota->ForeColor = System::Drawing::Color::White;
	this->lblGaviota->ForeColor = System::Drawing::Color::DarkViolet;
}
System::Void TutIntV30::Act1DosBD::textCangrejo_Click(System::Object^  sender, System::EventArgs^  e) {
	cambiarColor();
	this->textCangrejo->BackColor = System::Drawing::Color::DarkViolet;
	this->textCangrejo->ForeColor = System::Drawing::Color::White;
	this->lblCangrejo->ForeColor = System::Drawing::Color::DarkViolet;
}
System::Void TutIntV30::Act1DosBD::textTortuga_TextChanged(System::Object^  sender, System::EventArgs^  e) {
	tiempo_respuesta(1, t_item1, this->textTortuga);
	if (this->textTortuga->Text == "") {
		listoTortuga = false;
...
System::Void TutIntV30::Act1DosBD::textCangrejo_TextChanged(System::Object^  sender, System::EventArgs^  e) {
	tiempo_respuesta(4, t_item4, this->textCangrejo);
	if (this->textCangrejo->Text == "") {
		listoCangrejo = false;
		this->btnListo->Visible = false;
	}
	else {
...
System::Void TutIntV30::Act1DosBD::textGaviota_TextChanged(System::Object^  sender, System::EventArgs^  e) {
	tiempo_respuesta(2, t_item2, this->textGaviota);
	if (this->textGaviota->Text == "") {
		listoGaviota = false;
		this->btnListo->Visible = false;
	}
	else {
...
System::Void TutIntV30::Act1DosBD::textPelicano_TextChanged(System::Object^  sender, System::EventArgs^  e) {
	tiempo_respuesta(3, t_item3, this->textPelicano);
	if (this->textPelicano->Text == "") {
		listoPelicano = false;
		this->btnListo->Visible = false;
	}
	else {
